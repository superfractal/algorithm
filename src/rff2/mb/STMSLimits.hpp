...
inline const double maxInputLogZoom=std::floor((maxVerificationBits/std::log2(10.)-160)/2);
...
inline int64_t exponentLimit(int64_t bits){return std::max<int64_t>(1000000,2*bits+1024);}
}
